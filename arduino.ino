/* 쉽고 재밌는 코딩의 시작, 펀키트랩 www.funkit.kr */

/*스마트팜 키트_ 수분, 바람, 빛 공급편*/
...
#define A_1A 10 // 모터드라이버 A_1A 단자 연결 핀번호(워터모터용)
#define A_1B 9 // 모터드라이버 A_1B 단자 연결 핀번호
...
if(t >= 30 || h >= 70) { // 온도가 30이상 또는 습도가 80이상이면,  || => [Shift] + [\]
delay(5000);
